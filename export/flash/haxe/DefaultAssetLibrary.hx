...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/path.png", __ASSET__assets_images_path_png);
		type.set ("assets/images/path.png", AssetType.IMAGE);
...
@:keep class __ASSET__assets_data_level1_oel extends openfl.utils.ByteArray { }
@:keep class __ASSET__assets_images_images_go_here_txt extends openfl.utils.ByteArray { }
@:keep class __ASSET__assets_images_path_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:bitmap("assets/images/path.png") class __ASSET__assets_images_path_png extends flash.display.BitmapData {}
